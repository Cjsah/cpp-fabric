...
import static cpp.init.CppItems.EMERALD_TRADE_PLUGIN;
import static cpp.init.CppItems.GOLD_TRADE_PLUGIN;
import static cpp.init.CppItems.MOON_TRADE_PLUGIN;
...
//		addSell(24, EMERALD, 1, stacksOf(4, "_dye"), 1, 30);
		...
		SELL_TABLE.add(new Recipe(CppItems.MOON_SHARD, 1, 64, 40, blockEntity -> cpp.item.CharacterItem.randomGetOne(), Recipe.createTooltipModifier("item.cpp.character")));
