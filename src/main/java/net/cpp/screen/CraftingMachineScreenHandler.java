...
//	public static final RecipeBookCategory CATEGORY = RecipeBookCategory.CRAFTING;
	...
	public CraftingMachineScreenHandler(int syncId, PlayerInventory playerInventory,
		...
		super(Registeror.CRAFTING_MACHINE_HANDLER_TYPE, syncId);
	 ...
	 * 以下是自定义方法
	 */
	public CraftingMachineBlockEntity getBlockEntity() {
		return blockEntity;
	}
