...
public class AllInOneMachineScreen extends HandledScreen<CraftingMachineScreenHandler> {
...
//	private final RecipeBookWidget recipeBook = new RecipeBookWidget();
    ...
    public AllInOneMachineScreen(CraftingMachineScreenHandler handler, PlayerInventory inventory, Text title) {
