...
public class PortableCraftingTableScreen extends HandledScreen<PortableCraftingTableScreenHandler> implements RecipeBookProvider {
    ...
    public PortableCraftingTableScreen(PortableCraftingTableScreenHandler handler, PlayerInventory inventory, Text title) {
