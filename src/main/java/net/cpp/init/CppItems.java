...
public final class CppItems {
    ...
    static {
        ...
        BLUE_FORCE_OF_SKY = registerItem("blue_force_of_sky", new Item(new Item.Settings().group(CPP_GROUP_TOOL).maxCount(1)));
        GREEN_FORCE_OF_WATER = registerItem("green_force_of_water", new Item(new Item.Settings().group(CPP_GROUP_TOOL).maxCount(1)));
        CYAN_FORCE_OF_MOUNTAIN = registerItem("cyan_force_of_mountain", new Item(new Item.Settings().group(CPP_GROUP_TOOL).maxCount(1)));
        ORANGE_FORCE_OF_DIRT = registerItem("orange_force_of_dirt", new Item(new Item.Settings().group(CPP_GROUP_TOOL).maxCount(1)));
        YELLOW_FORCE_OF_EARTH = registerItem("yellow_force_of_earth", new Item(new Item.Settings().group(CPP_GROUP_TOOL).maxCount(1)));
        RED_FORCE_OF_FIRE = registerItem("red_force_of_fire", new Item(new Item.Settings().group(CPP_GROUP_TOOL).maxCount(1)));
        PURPLE_FORCE_OF_LIFE = registerItem("purple_force_of_life", new Item(new Item.Settings().group(CPP_GROUP_TOOL).maxCount(1)));
        WHITE_FORCE_OF_LIGHTNING = registerItem("white_force_of_lightning", new Item(new Item.Settings().group(CPP_GROUP_TOOL).maxCount(1)));
        BLACK_FORCE_OF_MOON = registerItem("black_force_of_moon", new Item(new Item.Settings().group(CPP_GROUP_TOOL).maxCount(1)));
