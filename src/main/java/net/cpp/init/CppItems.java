...
public final class CppItems {
    ...
    public static Item RARE_EARTH_GLASS = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item REINFORCED_GLASS = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    ...
    public static Item MOON_STONE = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item SUN_STONE = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    ...
    // 食物
    public static Item KETCHUP = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item STRAWBERRY_JAM = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BLUE_BERRY_JAM = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item ORANGE_JAM = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item CHERRY_JAM = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item APPLE_JAM = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item YEAST_POWDER = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BUTTER = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item CHEESE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item RAISIN = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item TOFFEE_APPLE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item CANDIED_HAW = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item CUPCAKE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item CAKE_ROLL = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item CROISSANT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item CARAMEL_PUDDING = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item DOUGHNUT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item PURPLE_DOUGHNUT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item PINK_DOUGHNUT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item WHITE_DOUGHNUT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BLUE_DOUGHNUT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item GREEN_DOUGHNUT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item HONEY_PANCAKE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BOILED_EGG = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BAKED_CARROT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BACON = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item VEGETABLE_KEBAB = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BEEF_KEBAB = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item PORK_KEBAB = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item LAMB_KEBAB = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item CHICKEN_KEBAB = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item RAW_COLORFUL_VEGETABLE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item RAW_BRAISED_PORK_WITH_POTATOES = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item RAW_BRAISED_BEEF_WITH_POTATOES = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item RAW_RABBIT_STEW = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item COLORFUL_VEGETABLE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BRAISED_PORK_WITH_POTATOES = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BRAISED_BEEF_WITH_POTATOES = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item RABBIT_STEW = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item DUMPLING = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item MEAT_FLOSS_BREAD = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item CHRISTMAS_ROAST_CHICKEN = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item FISH_AND_CHIPS = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BURGER = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item PIZZA = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item SUSHI = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item QINGTUAN = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item SAKURA_MOCHI = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item ZONGZI = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item ZONGZI_BOILED_EGG = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item ZONGZI_CHINESE_DATA = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item ZONGZI_COOKED_PORKCHOP = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item ZONGZI_SALT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item ZONGZI_SODA_WATER = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item ZONGZI_HONEY_BOTTLE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item SANDWICH = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item STARGAZY_PIE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BAKED_SHROOMLIGHT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item SOUL_FRIED_CHICKEN = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item LUXURIOUS_NETHERITE_BARBECUE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item ASSORTED_ROOT_CANDY = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item NETHERITE_MUSHROOM_STEW = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item DOUBLE_COLOR_VINE_SALAD = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item COLD_DRINK = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    // 水果
    public static Item APRICOT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BANANA = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item BLUEBERRY = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item CHERRY = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item CHINESE_DATE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item COCONUT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item GOLDEN_GRAPE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item GRAPE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item GRAPEFRUIT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item HAWTHORN = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item LEMON = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item LONGAN = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item LOQUAT = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item LYCHEE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item MANGO = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item ORANGE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item PAYAPA = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item PEACH = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item PEAR = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item PERSIMMON = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item PLUM = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item POMEGRANATE = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item STRAWBERRY = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item TOMATO = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    public static Item CITRUS = new Item(new Item.Settings().group(CPP_GROUP_FOOD));
    // 药剂
    public static Item AGENTIA_OF_LIGHTNESS = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_EYESIGHT = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_FIRE_SHIELD = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_WATERLESS = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_TRANSPARENTNESS = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_BOUNCE = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_AGILENESS = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_SHARPNESS = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_REJUVENESS = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_BLOOD = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_EXTREMENESS = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_SHIELD = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_TIDE = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_CHAIN = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_SKY = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_OCEAN = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_RIDGE = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_DIRT = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_EARTH = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_FIRE = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    public static Item AGENTIA_OF_LIFE = new Item(new Item.Settings().group(CPP_GROUP_MISC));
    // 植物
