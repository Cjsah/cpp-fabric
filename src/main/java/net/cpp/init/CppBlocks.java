...
public final class CppBlocks {
	...
	public static final Block TRADE_MACHINE = Registry.register(Registry.BLOCK, new Identifier("cpp:trade_machine"), new AllInOneMachineBlock());
	...
	public static final Block MOB_PROJECTOR = Registry.register(Registry.BLOCK, new Identifier("cpp:mob_projector"), new AllInOneMachineBlock());
	public static final Block BEACON_ENHANCER = Registry.register(Registry.BLOCK, new Identifier("cpp:beacon_enhancer"), new AllInOneMachineBlock());
	public static final Block GOLDEN_ANVIL = Registry.register(Registry.BLOCK, new Identifier("cpp:golden_anvil"), new AllInOneMachineBlock());
	public static final Block DUSTBIN = Registry.register(Registry.BLOCK, new Identifier("cpp:dustbin"), new AllInOneMachineBlock());
	public static final Block CHEST_DROPPER = Registry.register(Registry.BLOCK, new Identifier("cpp:chest_dropper"), new AllInOneMachineBlock());
	...
	public static final Block RARE_EARTH_GLASS = Registry.register(Registry.BLOCK, new Identifier("cpp:rare_earth_glass"), new Block(FabricBlockSettings.of(Material.METAL).requiresTool().breakByTool(FabricToolTags.PICKAXES, 2).strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL)));
	public static final Block REINFORCED_GLASS = Registry.register(Registry.BLOCK, new Identifier("cpp:reinforced_glass"), new Block(FabricBlockSettings.of(Material.STONE).requiresTool().breakByTool(FabricToolTags.PICKAXES, 3).strength(50.0F, 3600000.0F).sounds(BlockSoundGroup.METAL)));
