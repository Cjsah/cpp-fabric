...
public final class CppRecipes {
    ...
    public static final RecipeSerializer<CppCraftingShapedRecipe> CPP_CRAFTING_SHAPED = RecipeSerializer.register("cpp:crafting_shaped", new CppCraftingShapedRecipe.Serializer());

    public static final RecipeSerializer<CppCraftingShapelessRecipe> CPP_CRAFTING_SHAPELESS = RecipeSerializer.register("cpp:crafting_shapeless", new CppCraftingShapelessRecipe.Serializer());
