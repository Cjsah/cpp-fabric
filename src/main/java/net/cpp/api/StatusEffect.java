...
public class StatusEffect {
    ...
    @Nullable
    public static net.minecraft.entity.effect.StatusEffect byRawId(int rawId) {
        return (net.minecraft.entity.effect.StatusEffect)Registry.STATUS_EFFECT.get(rawId);
    }

    public static int getRawId(net.minecraft.entity.effect.StatusEffect type) {
    ...
    public net.minecraft.entity.effect.StatusEffect addAttributeModifier(EntityAttribute attribute, String uuid, double amount, EntityAttributeModifier.Operation operation) {
