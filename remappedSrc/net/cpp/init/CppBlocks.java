...
public final class CppBlocks {
	...
	public static final Block REINFORCED_GLASS = Registry.register(Registry.BLOCK,
			new Identifier("cpp:reinforced_glass"),
			new Block(FabricBlockSettings.of(Material.STONE).requiresTool().breakByTool(FabricToolTags.PICKAXES, 3)
					.strength(50.0F, 3600000.0F).sounds(BlockSoundGroup.METAL)));
	public static final Block MOON_STONE = Registry.register(Registry.BLOCK, new Identifier("cpp:moon_stone"),
			new Block(FabricBlockSettings.of(Material.METAL).requiresTool().breakByTool(FabricToolTags.PICKAXES, 2)
					.strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL)));
	public static final Block SUN_STONE = Registry.register(Registry.BLOCK, new Identifier("cpp:sun_stone"),
			new Block(FabricBlockSettings.of(Material.METAL).requiresTool().breakByTool(FabricToolTags.PICKAXES, 2)
